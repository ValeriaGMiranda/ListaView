...
public class MainActivity extends AppCompatActivity {
    ...
    public void cargarDatos(){
        lista.add(new Inmueble(R.drawable.c,"JuanaKoslay",1000D));
        lista.add(new Inmueble(R.drawable.c2,"Volcan",5000D));
        lista.add(new Inmueble(R.drawable.c3,"El Trapiche",3000D));
